<div class="header">
  <div class="container-fluid !direction !spacing">
      <div class="row">
          <div class="col-2 logo"  onclick="window.location.assign('index.php?page=student&controller=layouts&action=index');">
          ...
          <div class="col-3 row button-bar">
              <div class="mycourse" onclick="window.location.assign('index.php?page=student&controller=mycourse&action=index');">Khoá học của tôi</div>
              <div class="notice"><i class="fa fa-bell" aria-hidden="true"></i></div>
              <div class="user">
                    <ul>
                        <li onclick="window.location.assign('index.php?page=student&controller=profile&action=index');">Trang cá nhân</li>
                        <li onclick="window.location.assign('index.php?page=student&controller=login&action=logout');">Đăng xuất</li>
                    </ul>
              </div>   
          </div>
      </div>
