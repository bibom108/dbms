    ...
    <div class="wrapper">
        <div class="landing-1">
            ...
            if (isset($_SESSION['idStudent'])) {
              require "./views/student/header-logined.php"; 
            }
            else require "./views/student/header-unlogin.php"
            ?>
                           ...
                           $check = 0;
                            ...
                            $output .='<div class="card card-body mt-3 course-item-horizontal">
                                <div class="media align-items-center text-center text-lg-left flex-column flex-lg-row">
                                    <div class="mr-2 mb-3 mb-lg-0"> <img src="public/assets/images/course'.$i.'.jpg" width="150" height="150" alt=""> </div>
                                    ...
                                    <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                                        <h3 class="mb-0 font-weight-semibold">'.$rowcourse['fee'].'</h3>
