        ...
        <div class="landing-1">
            ...
            <div class="row width-1280 content" style="margin: auto;">
                <div class="image col-6">
                    <img src="public/assets/images/rafiki.png" alt="không load được">
                </div>
                <div class="col-5">
                    ...
                    <div class="default-login">
                        <form action="" method="post" role="form">
                            ...
                            <button class="button button-color-blue" name ="submit" type = "submit" onclick="window.location.assign('index.php?page=student&controller=profile&action=index');">
                                ĐĂNG NHẬP
                            </button>
                            <div class="register">
