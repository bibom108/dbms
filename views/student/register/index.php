...
<html lang="en">
  ...
  <body>
    <div class="landing-1">
        <?php require "./views/student/header-unlogin.php" ?>
                ...
                <div class="default-login">
                    <form action="" method="post">
                        ...
                        <div class="row btn">
                            ...
                            <div class="col-7">
                                <button class="button button-color-blue blue-contrast" onclick="window.location.assign('index.php?page=student&controller=login&action=index');">
                                    TRỞ VỀ ĐĂNG NHẬP
                                </button>
                            </div>
                        </div>
