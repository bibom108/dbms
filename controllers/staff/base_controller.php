...
class BaseController
{
  ...
  function render($file, $data = array())
  {
    ...
    $view_file = 'views/staff/' . $this->folder . '/' . $file . '.php';
    if (is_file($view_file)) {
      ...
      require_once('views/staff/basic_layouts.php');
    } else {
      // Nếu file muốn gọi ra không tồn tại thì chuyển hướng đến trang báo lỗi.
      header('Location: index.php?page=staff&controller=layouts&action=error');
    }
  }
}
