...
<div class="nav-bar-col">
    <ul>
        ...
        <?php
        if ($_SESSION['type'] == 'Quản lý chi nhánh'){
            echo '
        ...
        <?php
        if ($_SESSION['type'] == 'Quản lý khóa học' or $_SESSION['type'] == 'Chăm sóc khách hàng'){
            echo '
        ...
        <?php
        if ($_SESSION['type'] == 'Quản lý khóa học' or $_SESSION['type'] == 'Giáo viên'){
            echo '
        ...
        <?php
        if ($_SESSION['type'] == 'Chăm sóc khách hàng'){
            echo '
